...
$inputXlsx = "1099-NEC TEST FILE.xlsx"  # Change this to your input XLSX file path
$outputText = "1099-NEC-OutputFile-TxtTabDeliniated.txt"  # Change this to your desired output text file path
