...
$inputXlsx = "C:\Users\5CA\Documents\Scripts\FormatCSVScript\1099-NEC\1099-NEC-Testfile.xlsx"  # Change this to your input XLSX file path
$outputText = "1099-NEC-OutputFile(xlsx)-TxtTabDeliniated.txt"  # Change this to your desired output text file path
